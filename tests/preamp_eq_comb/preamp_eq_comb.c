...
int main()
{
    ...
    struct Params params = {
        .v_in_v_value = 0.0e+00f,
        .lfc_cap_cap_value = 4.7e-09f,
        .r_series_value = 1.0e+04f,
        .hfl_res_cap_res_value = 8.0e+04f,
        .hfl_res_cap_cap_value = 2.7e-09f,
        .hfc_cap_value = 3.3e-06f,
        .r_shunt_value = 4.674e+03f,
        .lfl_res_cap_res_value = 1.5e+04f,
        .lfl_res_cap_cap_value = 1.5e-07f,
    };
