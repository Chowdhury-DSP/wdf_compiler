...
int main()
{
    printf ("RC Lowpass test (variable)\n");
    ...
    struct Params params = {
        .Vplus_v_value = 1.0e+01f,
        .Vin_res_value = 1.0e+03f,
        .Vminus_v_value = -5.0e+00f,
        .Vminus_res_value = 25.0e3f,
        .R1_v_value = 0.5f,
        .R1_res_value = 15.0e3f,
        .C1_value = 4.0e-6f,
    };
